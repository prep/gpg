...
* If your private keys are stored on disk, you can use both PKCS1v15 and PSS for signing. However, if your private keys are stored on a smart card like a Yubikey, you can only use PKCS1v15 for singing. The reason for this is, is that the
